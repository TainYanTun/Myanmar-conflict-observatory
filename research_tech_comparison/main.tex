...
The comparison utilizes the Myanmar Conflict Observatory dataset, which synthesizes ACLED records from February 2021 to 2025. The dataset includes over 80,000 events, each containing spatial coordinates, actor taxonomies, and unstructured narrative notes. 

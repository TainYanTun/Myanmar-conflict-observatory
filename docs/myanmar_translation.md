...
*   **သုတေသနအဆင့် တိကျမှု**: ဖြစ်စဉ်များကို ခွဲခြားရာတွင် **၉၀.၈% တိကျမှု (Precision)** ရှိပြီး၊ ပုံမှန် ဒေတာစနစ်များထက် ကျန်းမာရေးနှင့် ဆက်စပ်သော ဖြစ်စဉ်များကို ပိုမို မြင်သာအောင် ဖော်ထုတ်ပေးနိုင်သည်။
